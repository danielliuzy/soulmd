...
**Your agent deserves a SOUL** OpenSOUL.md is a registry of AI personality files ([SOUL.md](https://soul.md)). Summon souls others have conjured, create your own from a prompt, or possess your OpenClaw Agent with a whole new personality.
